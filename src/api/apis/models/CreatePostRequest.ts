 ...
 */
export function instanceOfCreatePostRequest(
  value: object
): value is CreatePostRequest {
...
export function CreatePostRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    tags:
      json["tags"] == null
        ? null
        : (json["tags"] as Array<any>).map(TagResponseFromJSON),
...
export function CreatePostRequestToJSONTyped(
  value?: CreatePostRequest | null,
  ...
  return {
    ...
    tags:
      value["tags"] == null
        ? null
        : (value["tags"] as Array<any>).map(TagResponseToJSON),
