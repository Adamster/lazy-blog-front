    ...
    <div key={post.id} className={s.preview}>
      <div className={s.previewCover}>
        ...
        >
          {post?.coverUrl ? (
            ...
            <span className="font-bold">!LAZY</span>
          )}
        </Link>
      </div>
      ...
      <div className={s.previewContent}>
        <div className={classNames("author mb-2")}>
          <Link href={`/${author.userName}`} className="authorName">
            {author?.avatarUrl && (
          ...
          <div className="postInfo">
            <span
              className="flex"
              style={{
                color: post.rating > 0 ? "var(--color-primary)" : "inherit",
              }}
            >
              <StarIcon width={"1rem"} />
            ...
            <span
              className="flex"
              style={{
                color: post.comments > 0 ? "var(--color-primary)" : "inherit",
              }}
            >
        ...
        <Link href={`/${author.userName}/${post.slug}`} className="mb-4">
